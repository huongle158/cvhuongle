...
async function displayEducation() {
    ...
    const activTemplate = `<h2 class="text-uppercase text-danger">Activity, Achivement</h2>
                <hr>
                <ul class="list">
                ...
                <li class="list-item mb-4">
                    <h4 class="display-6 text-uppercase">${activData[0].activity2}</h4>
                </li>
                <li class="list-item mb-4">
                    <h4 class="display-6 text-uppercase">${activData[0].activity3}</h4>
                </li>
                
              </ul>`;
    eduEle.insertAdjacentHTML("afterbegin", eduTemplate)
    skillEle.innerHTML = skillTemplate;
    activEle.innerHTML=activTemplate;
