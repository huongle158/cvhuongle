...
async function displayEducation() {
    ...
    const activEle = `<h2 class="text-uppercase text-danger">Activity, Achivement</h2>
                <hr>
                <ul class="list">
                
                 <li class="list-item mb-4">
                    <h4 class="display-6 text-uppercase">{activData[0].activity1}</h4>
                </li>
                <li class="list-item mb-4">
                    <h4 class="display-6 text-uppercase">Join the Spring Volunteer Spring at the University of Natural Sciences (2021)</h4>
                </li>
                <li class="list-item mb-4">
                    <h4 class="display-6 text-uppercase">Join the volunteering campaign to distribute porridge for the homeless (8/2020)</h4>
                </li>
